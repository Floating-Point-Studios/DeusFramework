...
function Array3D.Methods:Multiset(x0, y0, z0, x1, y1, z1, v)
    ...
    Output.assert(z0 >= 1 and z0 <= self.Size.Z, "Argument #3 is out of bounds")
    Output.assert(x1 >= 1 and x1 <= self.Size.X, "Argument #4 is out of bounds")
    Output.assert(y1 >= 1 and y1 <= self.Size.Y, "Argument #5 is out of bounds")
    Output.assert(z1 >= 1 and z1 <= self.Size.Z, "Argument #6 is out of bounds")
